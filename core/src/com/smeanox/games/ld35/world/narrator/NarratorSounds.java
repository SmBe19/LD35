...
public enum NarratorSounds {
	...
	lvl2_6("nar/Lvl2_6.mp3", 05.74f, new String[]{"Unfortunately, these rocks destroyed the bridge that used to be here, so you will have to find another way."}),
	...
	lvl3_13("nar/Lvl3_13.mp3", 04.06f, new String[]{"A moving platform! I kindly ask you to not think about how this is physically possible."}),
	...
	lvl5_3("nar/Lvl5_3.mp3", 03.25f, new String[]{"Yep, alligators are definitely on my grocery list."}),
	...
	lvl8_2("nar/Lvl8_2.mp3", 17.57f, new String[]{"And here it comes: the thing we've all been waiting for: The Bea...", "wait what? There's no bear? Ah right, it was cut due to budget reasons.", "Damn. All that hype for nothing. Whatever. I think this will serve as a nice replacement."}),
